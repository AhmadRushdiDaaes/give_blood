                     ...
                     <div class="signup-form">
                        ...
                        <form method="post" class="register-form" id="register-form">
                           <div class="form-group">
                              ...
                              <input type="text" name="visitor_fullname" id="name" placeholder="إسم المستخدم"/>
                           </div>
                           <div class="form-group">
                              <label for="email"><i class="zmdi zmdi-email"></i></label>
                              <input type="email" name="visitor_email" id="email"  placeholder="الايميل"/>
                           </div>
                           <div class="form-group">
                              <label for="pass"><i class="zmdi zmdi-lock"></i></label>
                              <input type="password" name="visitor_password" id="visitor_password" placeholder="كلمة السر"/>
                           </div>
                           <div class="form-group">
                              <label for="re-pass"><i class="zmdi zmdi-lock-outline"></i></label>
                              <input type="password" name="confirm_password" id="confirm_password" placeholder="أعد كتابة كلمة السر"/>
                           </div>
                           <div class="form-group">
                              <input type="checkbox" name="agree-term" id="agree-term" class="agree-term" />
                              <label for="agree-term" class="label-agree-term"><span><span></span></span>أوافق على كل شيء موجود في <a href="#" class="term-service">شروط السياسة</a></label>
                           </div>
                           <div class="form-group form-button">
                              <input type="submit" name="submit" id="signup" class="form-submit" value="إنشاء الحساب"/>
                           </div>
                        </form>
                     </div>
                     <div class="signup-image">
                        <figure><img src="images/signup-image.jpg" alt="sing up image"></figure>
                        <a href="sign-in.php" style="padding: 10px;" class="signup-image-link">أنا بالأصل مشترك</a>
                     </div>
                  </div>
               </div>
            </section>
