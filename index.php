      ...
      <section>
         <div class="row container-fluid">
            ...
            <div style="align-self: center; text-align: center;" class="col-md-6 col-xs-6">
               <p style="font-family: 'Scheherazade', serif; font-size:30px">يعتبر التبرع بالدم عملية تطوعية يمكن أن تساعد في إنقاذ حياة الآخرين. توجد أنواع عديدة من التبرع بالدم.التي يمكن أن تساعد في تلبية الاحتياجات الطبية المختلفة.</p>
            </div>
         </div>
      </section>
         ...
         <div class="u-clearfix u-sheet u-sheet-1">
            <div class="u-align-center u-container-style u-group u-group-1">
               <div class="u-container-layout u-valign-middle u-container-layout-1">
                  <h1 class="u-text u-text-1">فوائد المتبرع</h1>
               </div>
            </div>
                        ...
                        <div class="u-layout-col">
                           <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-5">
                              <div class="u-container-layout u-valign-top u-container-layout-6">
                                 <h3 class="u-text u-text-9 fontt">التبرع بالدم يحرق طنا من السعرات الحرارية</h3>
                              </div>
                           </div>
                           <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-6">
                              <div class="u-container-layout u-valign-top u-container-layout-7">
                                 <h3 class="u-text u-text-11 fontt">تنشيط النخاع العظمي لإنتاج خلايا دم جديدة</h3>
                              </div>
                           </div>
                           <div class="u-align-left u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-7">
                              <div class="u-container-layout u-valign-top u-container-layout-8">
                                 <h3 class="u-text u-text-13 fontt">يقلل خطر ارتفاع ضغط الدم</h3>
                              </div>
                           </div>
                        </div>
                     </div>
